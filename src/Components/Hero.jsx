    ...
    return (
        <div>
            ...
            <div className="pl-[5%] h-screen w-screen bg-[url('https://i.imgur.com/15kLXCo.jpg')] bg-contain hidden sm:block">
                ...
                <div className="flex justify-center">
                    <img ref={tedxLogoRef}
                     src="https://i.imgur.com/sNLtX0F.png" alt="tedx-davv-logo" className="w-48 h-48 top-[8rem] relative scale-[280%]" />
                </div>
                <div className="">
                    <img ref={planetRef}
                     src="https://i.imgur.com/ud5pNJs.png" alt="Planet" className="relative left-[66rem] top-[-10rem] h-24" />
                </div>
                <img
                 src="https://i.imgur.com/iEkwjMj.png" alt="Clouds" className="relative w-auto h-64 left-[32.5rem] bottom-36 scale-[400%] overflow-hidden" />
                <div className="flex w-screen justify-center">
                    <img ref={planeRef}
                    src="https://i.imgur.com/ZAg3b4l.png" alt="Plane" className="relative h-24 left-[4rem] bottom-[30.6rem] scale-[150%]" />
                </div>
                <img ref={ballonRef}
                 src="https://i.imgur.com/kKKVr8M.png" alt="Balloon" className="relative h-24 left-[31.25rem] bottom-[24.3rem] scale-[500%]" />
                <div className="relative">
                ...
                <img ref={rocketRef} 
                src="https://i.imgur.com/57IN6rJ.png" alt="rocket" className="relative w-auto h-96 left-[67.5rem] bottom-[61.25rem]" />
